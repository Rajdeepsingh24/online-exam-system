...
SECRET_KEY = 'django-insecure-s%hljap4yln6@sg5ki%ua2#hijvhm(d%8$k707^6m=@^+p=x@#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['online-exam-system-ik5a.onrender.com']
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to Exam System Admin",
    "show_sidebar": True,
